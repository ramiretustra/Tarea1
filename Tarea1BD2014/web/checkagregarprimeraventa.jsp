...
<html>
    ...
    <body>
        <% 
            ...
            String id_c = request.getParameter("id_cliente");
            int int_id_c = Integer.parseInt(id_c);
            ...
            String sql = "insert into venta(id_cliente,id_usuario, fecha) values("+id_c+","+idusuario+",'"+fecha+"')";
