...
<html>
    ...
    <body>
        <form method="post" action="checkagregarinfinitacompra.jsp" onsubmit="return validarForm(this);">
            <pre>
                Producto: <%
            ...
            <input type="submit" value="Agregar">
                ...
                <a href="checkterminarcompra.jsp"><input type="submit" value="Terminar" ></a>
